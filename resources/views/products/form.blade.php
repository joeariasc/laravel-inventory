    ...
    <div class="page-body">
        <div class="container-xl">
            <div class="row row-cards">
                ...
                <form action="{{ ! $product->id ? route('products.store') :  route('products.update', $product)}}"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select name="category_id" id="category_id"
                                                    ...
                                                    @foreach ($categories as $id => $category)
                                                        <option value="{{ $id }}"
                                                                @if (old('category_id', $product->category_id) == $id) selected="selected" @endif>
                                                            {{ $category }}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select name="unit_id" id="unit_id"
                                                    ...
                                                    @foreach ($units as $id => $unit)
                                                        <option value="{{ $id }}"
                                                                @if (old('unit_id', $product->unit_id) == $id) selected="selected" @endif>
                                                            {{ $unit }}</option>
                                                    @endforeach
                                                </select>
